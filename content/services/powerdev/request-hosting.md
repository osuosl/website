  ...
  method="post" id="webform-client-form-1086" accept-charset="UTF-8">
    <div>
      ...
      <div class="form-item webform-component webform-component-select" id="webform-component-power-architecture">
        ...
        is required.">&ast;</span></label>
        <select id="edit-submitted-power-architecture" name="power_architecture" class="form-select required" required>
      ...
      <input type="hidden" name="mail_subject_prefix" value="New PowerLinux/OpenPOWER Hosting Request" required />
      <input type="hidden" name="mail_subject_key" value="project_name" required />
      <input type="hidden" name="send_to" value="PowerDev" required />
      <!-- /Formsender Settings -->
